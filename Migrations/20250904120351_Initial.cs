        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_entries_users_author_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_entry_tags", x => new { x.EntriesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_entry_tags_entries_EntriesId",
                        column: x => x.EntriesId,
                        principalTable: "entries",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_entry_tags_tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "tags",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_entries_author_id",
                table: "entries",
                column: "author_id");

            migrationBuilder.CreateIndex(
                name: "IX_entry_tags_TagsId",
                table: "entry_tags",
                column: "TagsId");
